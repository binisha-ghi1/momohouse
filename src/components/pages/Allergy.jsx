  ...
  return (
     <div>
           <div className='flex items-center pl-10'>
              <div className="w-[50%]">
             <p className="text-3xl text-teal-800  font-bold ml-20"> <span className="italic">Allergy Advice </span></p><br></br><br></br>
           ...
           <div >
            <div className='flex flex-col justify-center  gap-8 items-center mt-20'>

              <h1 className='text-4xl mb-6 text-black font-extrabold'><span className='text-orange-600'>Ingridient's</span> Used</h1>
             <div className='flex h-54 border-teal-800 border-4 rounded-xl w-[40%]  pl-10 '>
              <ul className='  mb-20  list-disc'>
                <h1 className='text-black  font-medium  text-2xl mt-4 mb-8'>For The Dough :</h1>
              <li>120 grams refined flour</li>
              <li>1/2 tsp baking powder</li>
              <li>1/2 tsp salt water (for kneading)</li>
              </ul> 
             </div>
             <div  className='flex border-teal-800 border-4 rounded-xl w-[40%] pl-10 mt-4'>
              <ul className=' list-disc mb-8'>
                <h1 className='text-black  font-medium text-2xl mt-4 pb-8 '>For The Chicking Filling :</h1>
              ...
              <li>Salt</li>
              <li className="">1/4 tsp vinegar</li>
             ...
             <div  className='flex  border-teal-800 border-4 rounded-xl w-[40%] pl-10 mt-4'>
              <ul className=' list-disc mb-8'>
                <h1 className='text-black  font-medium text-2xl mt-8 pb-4 mb-4'>For The Vegeterian Filling :</h1>
             ...
             <div  className='flex  border-4 border-teal-800 rounded-xl w-[40%] pl-10 mt-4'>
              <ul className=' list-disc mb-8'>
                <h1 className='text-black  font-medium text-2xl mt-8 pb-4 mb-4'>For The Chilli Sauce :</h1>
           ...
           <div className='flex  mt-20 items-center justify-center'>
            <div  >
            <h1 className='mb-10 items-center justify-center flex text-4xl font-extrabold '> <span className='text-orange-600'>Allergy  &nbsp;</span> 
               Advice</h1>
...
Quam ipsum viverra ac laoreet platea in praesent. Mattis molestie arcu nulla convallis interdum proin dui ut porta. Amet potenti praesent pulvinar<br/> scelerisque vitae habitant eget. Senectus hac id aliquam ipsum urna. Est ut amet nec sollicitudin nunc viverra nec ipsum suspendisse. Etiam risus<br/> ultricies dictum nisl. Bibendum ultrices elementum feugiat erat suspendisse mi fermentum magna suspendisse. Nisi mattis consequat nec donec eu<br/> amet nulla a. At blandit vulputate morbi tortor amet. Hac nec gravida tempor ac. Senectus nunc libero scelerisque quisque. Risus condimentum<br/> mattis massa integer.</p>
           ...
           <div className='flex ml-34 mt-20 items-center w-[80%] ml-40 mb-20 bg-slate-100 shadow-xl shadow-slate-400 justify-center'>
            <div>
            <h1 className='mb-4 mt-8 ml-38 items-center justify-center flex w-full text-3xl  font-bold  text-teal-800'>Scan the QR to Pay</h1>
            <p className='text-gray-500 mb-6'>You can also check the  allergy advice  using your phone as well</p>
            <div >
              <img src={QR} className=' ml-40 h-44 pb-4'/>
              <div className="flex flex-row ml-10 items-center justify-center mb-8">
            <p className="text-2xl  font-bold"><span className="text-orange-600">Scan</span> Me!</p>
            <p className="text-2xl font-bold"><FaMobileScreenButton /></p>
        </div>
        </div>
             </div>
             </div>
